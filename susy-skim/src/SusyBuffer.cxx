...
SusyBuffer::SusyBuffer(SmartChain *fChain, unsigned br, BranchNames names)
{
  ...
  fChain->SetBranchAddress("jet_AntiKt4TopoNewEM_n", &jet_AntiKt4TopoNewEM_n, true); 
  fChain->SetBranchAddress("jet_AntiKt4TopoNewEM_E", &jet_AntiKt4TopoNewEM_E, true); 
  fChain->SetBranchAddress("jet_AntiKt4TopoNewEM_pt", &jet_AntiKt4TopoNewEM_pt, true); 
  fChain->SetBranchAddress("jet_AntiKt4TopoNewEM_eta", &jet_AntiKt4TopoNewEM_eta, true); 
  fChain->SetBranchAddress("jet_AntiKt4TopoNewEM_phi", &jet_AntiKt4TopoNewEM_phi, true); 
  fChain->SetBranchAddress("jet_AntiKt4TopoNewEM_EtaOrigin", &jet_AntiKt4TopoNewEM_EtaOrigin, true); 
  fChain->SetBranchAddress("jet_AntiKt4TopoNewEM_PhiOrigin", &jet_AntiKt4TopoNewEM_PhiOrigin, true); 
  fChain->SetBranchAddress("jet_AntiKt4TopoNewEM_MOrigin", &jet_AntiKt4TopoNewEM_MOrigin, true); 
  fChain->SetBranchAddress("jet_AntiKt4TopoNewEM_Timing", &jet_AntiKt4TopoNewEM_Timing, true); 
  fChain->SetBranchAddress("jet_AntiKt4TopoNewEM_LArQuality", &jet_AntiKt4TopoNewEM_LArQuality, true); 
  fChain->SetBranchAddress("jet_AntiKt4TopoNewEM_sumPtTrk", &jet_AntiKt4TopoNewEM_sumPtTrk, true); 
  fChain->SetBranchAddress("jet_AntiKt4TopoNewEM_HECQuality", &jet_AntiKt4TopoNewEM_HECQuality, true); 
  fChain->SetBranchAddress("jet_AntiKt4TopoNewEM_NegativeE", &jet_AntiKt4TopoNewEM_NegativeE, true); 
  fChain->SetBranchAddress("jet_AntiKt4TopoNewEM_AverageLArQF", &jet_AntiKt4TopoNewEM_AverageLArQF, true); 
  fChain->SetBranchAddress("jet_AntiKt4TopoNewEM_BCH_CORR_CELL", &jet_AntiKt4TopoNewEM_BCH_CORR_CELL, true); 
  fChain->SetBranchAddress("jet_AntiKt4TopoNewEM_BCH_CORR_DOTX", &jet_AntiKt4TopoNewEM_BCH_CORR_DOTX, true); 
  fChain->SetBranchAddress("jet_AntiKt4TopoNewEM_BCH_CORR_JET", &jet_AntiKt4TopoNewEM_BCH_CORR_JET, true); 
  fChain->SetBranchAddress("jet_AntiKt4TopoNewEM_SamplingMax", 
			   &jet_AntiKt4TopoNewEM_SamplingMax, true); 
  fChain->SetBranchAddress("jet_AntiKt4TopoNewEM_fracSamplingMax", 
			   &jet_AntiKt4TopoNewEM_fracSamplingMax, true); 
  fChain->SetBranchAddress("jet_AntiKt4TopoNewEM_hecf", &jet_AntiKt4TopoNewEM_hecf, true); 
  fChain->SetBranchAddress("jet_AntiKt4TopoNewEM_emfrac", &jet_AntiKt4TopoNewEM_emfrac, true); 
  fChain->SetBranchAddress("jet_AntiKt4TopoNewEM_emscale_E", &jet_AntiKt4TopoNewEM_emscale_E, true); 
  fChain->SetBranchAddress("jet_AntiKt4TopoNewEM_emscale_eta", &jet_AntiKt4TopoNewEM_emscale_eta, true); 
  fChain->SetBranchAddress("jet_AntiKt4TopoNewEM_flavor_weight_JetFitterCOMBNN", &jet_AntiKt4TopoNewEM_flavor_weight_JetFitterCOMBNN, true); 
  fChain->SetBranchAddress("jet_AntiKt4TopoNewEM_flavor_truth_label", &jet_AntiKt4TopoNewEM_flavor_truth_label, true); 
  fChain->SetBranchAddress("jet_AntiKt4TopoNewEM_flavor_component_jfitcomb_pu", &jet_AntiKt4TopoNewEM_flavor_component_jfitcomb_pu, true);
  fChain->SetBranchAddress("jet_AntiKt4TopoNewEM_flavor_component_jfitcomb_pb", &jet_AntiKt4TopoNewEM_flavor_component_jfitcomb_pb, true);
  fChain->SetBranchAddress("jet_AntiKt4TopoNewEM_flavor_component_jfitcomb_pc", &jet_AntiKt4TopoNewEM_flavor_component_jfitcomb_pc, true);
